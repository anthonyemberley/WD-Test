...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (cell == nil) {
        ...
        {
            //See if the imageData is in Core Data
            ...
            [fetchRequest setPredicate:[NSPredicate predicateWithFormat:@"objectId == %@", tastingObject.objectId]];
            
            NSError *error;
            
            NSArray *fetchedRecords = [managedObjectContext executeFetchRequest:fetchRequest error:&error]; //Array of ImageDataOffline objects
            
            if (fetchedRecords.count > 0) imageData = [fetchedRecords objectAtIndex:0];
